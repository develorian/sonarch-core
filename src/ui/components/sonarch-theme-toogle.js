import { defineComponent, themeSignal } from '../../core/engine.js';

defineComponent('sonarch-theme-toggle', () => {
    ...
    return {
        template: `<button class="p-2 rounded-full cursor-pointer bg-glass border-glass text-dark transition" id="theme-btn"></button>`,
        setup: (shadowDOM) => {
            ...
            // Reaccionar al estado global
            themeSignal.subscribe(updateIcon);
