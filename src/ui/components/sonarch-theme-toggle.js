...
defineComponent('sonarch-theme-toggle', () => {
    ...
    return {
        template: `<button class="p-2 rounded-full cursor-pointer bg-glass border-glass text-dark transition" id="theme-btn" style="background:transparent; border:none; color:var(--text-main);"></button>`,
        setup: (shadowDOM) => {
